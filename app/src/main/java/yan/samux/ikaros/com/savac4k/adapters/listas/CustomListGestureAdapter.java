 ...
 */
public class CustomListGestureAdapter extends BaseAdapter {

    private Activity activity;
    private LayoutInflater inflater;
    private List<Gestos> elementos;
    ImageLoader imageLoader = AppControllerClass.getInstance().getImageLoader();

    public CustomListGestureAdapter(Activity activity, List<Gestos> elementos){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Gestos m = elementos.get(position);
