 ...
 */
public class CustomListObjetosAdapter extends BaseAdapter {

    private Activity activity;
    private LayoutInflater inflater;
    private List<Objetos> elementos;
    ImageLoader imageLoader = AppControllerClass.getInstance().getImageLoader();

    public CustomListObjetosAdapter(Activity activity, List<Objetos> elementos){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Objetos m = elementos.get(position);
